...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), vin="", has_relay=False):
    ...
    if candidate in [CAR.IMPREZA, CAR.CROSSTREK]: #== CAR.CROSSTREK:
      ...
      ret.steerActuatorDelay = 0.4   # end-to-end angle controller
      ret.lateralTuning.pid.kf = 0.00005
      ret.lateralTuning.pid.kpBP, ret.lateralTuning.pid.kiBP =  [[0., 15.], [0., 15.]] # [[0., 10., 20., 30.], [0., 20., 30.]] #[[0., 10., 20., 30.], [0., 20., 30.]]
      ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV =  [[0.05, 0.25], [0.1, 0.05]] #[[0.05, 0.15, 0.25, 0.4], [0.02, 0.03, 0.04]] #[[0.05, 0.2, 0.3, 0.4], [0.02, 0.03, 0.04]]
      ret.steerMaxBP = [0.] # m/s
      ret.steerMaxV = [1.]
