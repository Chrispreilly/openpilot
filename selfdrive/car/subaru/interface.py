...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    ret.carName = "subaru"
    #ret.radarOffCan = True //show car on UI
    ...
    if candidate in [CAR.IMPREZA, CAR.CROSSTREK]: #== CAR.CROSSTREK:
      ...
      ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.05, 0.15, 0.25, 0.4], [0.02, 0.03, 0.03]] #[[0.05, 0.15, 0.25, 0.4], [0.02, 0.03, 0.04]] #[[0.05, 0.2, 0.3, 0.4], [0.02, 0.03, 0.04]]
      ret.steerMaxBP = [0.] # m/s
      ret.steerMaxV = [1.]
